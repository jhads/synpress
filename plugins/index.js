...
module.exports = (on, config) => {
  ...
  on('task', {
    ...
    signMetamaskTransaction: async () => {
      const signed = await metamask.signMetamaskTransaction();
      return signed;
    },
    cancelMetamaskSignature: async () => {
      const cancelled = await metamask.cancelMetamaskSignature();
      return cancelled;
    },
